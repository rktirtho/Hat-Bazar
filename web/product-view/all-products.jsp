<%-- 
    ...
    Created on : Mar 30, 2019, 5:21:54 AM
    Author     : DELL
--%>
...
<html>
    <%
        ...
        List<Product> productList = ProductDBHelper.getAll();

        request.setAttribute("product", productList);
    %>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Hat Bazar | All</title>
                        ...
                        <div class="">
                            <div class="">
                                <div class="list-group">
                                    <a href="all-products" class="list-group-item active">All Product</a>
